...
ROLE_PERMISSIONS: dict[UserRole, set[Permission]] = {
    UserRole.OWNER: _ALL_TICKET_PERMS | _ALL_TEAM_PERMS | _ALL_WORKFLOW_PERMS | {Permission.CUSTOMER_MANAGE},
    UserRole.ADMIN: _ALL_TICKET_PERMS | _ALL_TEAM_PERMS | _ALL_WORKFLOW_PERMS | {Permission.CUSTOMER_MANAGE},
    UserRole.MANAGER: {
        Permission.TICKET_CREATE, Permission.TICKET_UPDATE_STATUS, Permission.TICKET_UPDATE_PRIORITY,
        ...
        Permission.WORKFLOW_MANAGE, Permission.CUSTOMER_MANAGE,
    },
    UserRole.AGENT: {
        ...
        # support work, not an admin action.
        Permission.TICKET_CREATE, Permission.TICKET_UPDATE_STATUS, Permission.TICKET_UPDATE_PRIORITY,
        Permission.TICKET_ASSIGN, Permission.TICKET_COMMENT, Permission.TICKET_INTERNAL_NOTE,
